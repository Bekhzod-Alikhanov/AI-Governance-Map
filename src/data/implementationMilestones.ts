...
export const IMPLEMENTATION_MILESTONES: ImplementationMilestone[] = [
  ...
  },
  {
    ...
    summary:
      "The AI Omnibus changed the deadline for AI Act rules governing Annex III high-risk AI systems to 2 December 2027.",
    sourceName: "European Commission - AI Omnibus enters into force",
    sourceUrl: "https://digital-strategy.ec.europa.eu/en/news/ai-omnibus-enters-force",
    ...VERIFIED,
    lastVerified: "2026-08-17",
    ...
    verificationNotes:
      "Changed deadline confirmed by the official Commission AI Omnibus announcement; this date is specific to Annex III high-risk AI systems.",
  },
  {
    ...
    summary:
      "The AI Omnibus changed the deadline for high-risk AI systems embedded in products regulated under Annex I to 2 August 2028.",
    sourceName: "European Commission - AI Omnibus enters into force",
    sourceUrl: "https://digital-strategy.ec.europa.eu/en/news/ai-omnibus-enters-force",
    ...VERIFIED,
    lastVerified: "2026-08-17",
    reviewStatus: "editorial_checked",
    verificationNotes:
      "Changed deadline confirmed by the official Commission AI Omnibus announcement; this date is specific to high-risk systems embedded in Annex I regulated products.",
  },
  {
  ...
  },
  {
    ...
    status: "adopted",
    date: "2024-05-17",
    label: "CoE AI Convention adopted; not yet in force as of release status date",
    summary:
      "The Convention was adopted and opened for signature, but entry-into-force conditions had not been met as of the release status date.",
  ...
  {
    id: "uk-pro-innovation-guidance-issued",
    parentType: "national_rule",
    parentId: "uk-pro-innovation-approach",
    jurisdiction: "United Kingdom",
    status: "guidance_issued",
    date: "2024-02-06",
    label: "UK pro-innovation AI regulation response issued",
    summary:
      "The UK cross-regulator principles approach is tracked as guidance and institutional implementation context, not as an omnibus AI statute.",
  ...
  {
    id: "uk-ai-regulation-bill-proposed",
    parentType: "national_rule",
    parentId: "uk-ai-regulation-bill-2025",
    jurisdiction: "United Kingdom",
    status: "proposed",
    date: "2025-03-04",
    label: "UK Artificial Intelligence (Regulation) Bill in House of Lords",
    summary:
      "Private member's bill tracked as proposed; it is not counted as enacted UK AI law.",
    sourceName: "UK Parliament - Artificial Intelligence (Regulation) Bill",
    sourceUrl: "https://bills.parliament.uk/bills/4126",
    ...LIKELY,
  },
  {
    id: "it-law-132-in-force",
    parentType: "national_rule",
    parentId: "it-law-132-2025",
    jurisdiction: "Italy",
    status: "in_force",
    date: "2025-10-10",
    label: "Italy Law No. 132/2025 in force",
    summary:
      "Italy's national artificial-intelligence law is tracked as in force and includes competent-authority designations for EU AI Act implementation.",
    sourceName: "Gazzetta Ufficiale - Law 132/2025",
    sourceUrl: "https://www.gazzettaufficiale.it/eli/id/2025/09/25/25G00143/sg",
    ...VERIFIED,
  },
  {
    id: "it-law-132-regulators-appointed",
    parentType: "national_rule",
    parentId: "it-law-132-2025",
    jurisdiction: "Italy",
    status: "regulator_appointed",
    date: "2025-10-10",
    label: "Italy designates ACN and AGID roles",
    summary:
      "The Italian law record tracks ACN and AGID as competent national authorities for AI-system monitoring and inspection.",
    sourceName: "Gazzetta Ufficiale - Law 132/2025",
    sourceUrl: "https://www.gazzettaufficiale.it/eli/id/2025/09/25/25G00143/sg",
    ...VERIFIED,
  },
  {
    id: "si-ai-act-implementation-in-force",
    parentType: "national_rule",
    parentId: "si-eu-ai-act-implementation-2025",
    jurisdiction: "Slovenia",
    status: "in_force",
    date: "2025-11-21",
    label: "Slovenia EU AI Act implementation law in force",
    summary:
      "Slovenia's EU AI Act implementation law is tracked as in force from the official PISRS record.",
  ...
  },
  {
    ...
    parentType: "subnational_rule",
    parentId: "de-ai-act-implementation-draft",
    jurisdiction: "Germany",
    status: "proposed",
    date: "2025-04-01",
    label: "Germany draft EU AI Act implementation bill",
    summary:
      "German implementation activity is tracked as draft/proposed pending promulgation.",
  ...
  {
    id: "fr-ai-act-implementation-activity",
    parentType: "subnational_rule",
    parentId: "fr-ai-act-implementation-draft",
    jurisdiction: "France",
    status: "implementing_rules_pending",
    date: "2025-06-01",
    label: "France EU AI Act implementation activity tracked",
    summary:
      "French activity is tracked as implementation context and supervisory work; no comprehensive national implementation act is counted here.",
    sourceName: "CNIL - Annual Report 2025",
    sourceUrl: "https://www.cnil.fr/sites/default/files/2026-05/rapport_annuel_2025.pdf",
    ...LIKELY,
  },
  {
    id: "es-ai-law-draft-proposed",
    parentType: "national_rule",
    parentId: "es-ai-law-draft-2025",
    jurisdiction: "Spain",
    status: "proposed",
    date: "2025-03-11",
    label: "Spain draft AI law approved as preliminary draft",
    summary:
      "Spain's EU AI Act implementation draft is tracked as proposed and not as an enacted national AI law.",
