...
export const GOVERNANCE_OBLIGATIONS: GovernanceObligation[] = [
  ...
  },
  {
    ...
    caveat: "As of the release status date, the Convention was not yet in force; treaty duties apply only for parties once entry-into-force conditions are met.",
  ...
  },
  {
    ...
    caveat: "This remains a proposal in the release and must not be treated as binding law.",
